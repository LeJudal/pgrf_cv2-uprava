...
public interface Liner<P> {
     ...
     */
    void drawLine(final RasterImage<Integer> img, final int c1,
                  final int r1, final int c2, final int r2, final int pixelValue);

    void drawDashedLine(final RasterImage<Integer> img, final int c1,
                        final int r1, final int c2, final int r2, final int pixelValue);
